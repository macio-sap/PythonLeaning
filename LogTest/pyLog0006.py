...
class Logger():
    def __init__(self, log_name, logger_name):
        ...
        rHandler = RotatingFileHandler(logname,maxBytes = 512*1024,backupCount = 3)
    ...
    def outputLogInfo(self,msg):
        self.logger.info(msg, exc_info=True)
        
if __name__ == '__main__':
    print(os.getcwd())
    Log = Logger('create_log',logger_name=__name__)
    Log.outputLog()
    p8.testP6log()
